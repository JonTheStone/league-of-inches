...
<div class="constitution">
    <h1 class="noUnderscore">THIS PAGE IS STILL UNDER CONSTRUCTION!</h1>
    <h1 class="noUnderscore">LEAGUE OF INCHES CONSTITUTION</h1>
    ...
    <p>2 IR Spots (Player must be labeled as IR, Out, Doub, Sus, or Covid in the Sleeper App)</p>

        <h4 bind:this={oneOneOne}>1.1.1 Position Maximums</h4>

        <div class="subBlock">
            <p>We do not enforce position maximums.</p>
...
<!--            </table>-->
    ...
    <p>Trading of players is allowed. Trades will process immediately and will be reversed if under investigation for collusion. Tradable assets include players and FAAB $.</p>
